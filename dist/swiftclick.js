...
function SwiftClick(contextEl) {
  ...
  var SWIFTCLICK_IGNORE_CLASS_NAME = 'swiftclick-ignore';
  var SWIFTCLICK_FORCE_CLICK_CLASS_NAME = 'swiftclick-force';
...
SwiftClick.prototype.addNodeNamesToTrack = function (nodeNamesArray) {
  ...
  nodeNamesArray.forEach(function (nodeName) {
    if (typeof nodeName !== 'string') {
      throw new TypeError('all values within the "nodeNames" array must be of type "string"');
    }

    var currentNodeName = nodeName.toLowerCase();
    _this.options.elements[currentNodeName] = currentNodeName;
  });
};
